...
def plotProfile(xarr,yarr,xlim=None,ylim=None,xscale="log",yscale="log",xlabel=None,ylabel=None,color="black",ls="-",lw=3,label=None):
    ...
    return plt.plot(xarr,yarr,color=color,ls=ls,label=label,lw=lw)
